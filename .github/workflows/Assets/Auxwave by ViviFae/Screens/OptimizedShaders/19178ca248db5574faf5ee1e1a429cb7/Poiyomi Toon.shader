Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/19178ca248db5574faf5ee1e1a429cb7"
{
	Properties
	{
		...
		[sRGBWarning(true)]_MainTex_ScreenAlt ("Texture--{reference_properties:[_MainTexPan, _MainTexUV, _MainPixelMode, _MainTexStochastic, _MainIgnoreTexAlpha]}", 2D) = "white" { }
		...
		_Saturation_ScreenAlt ("Saturation", Range(-1, 10)) = 0
		_MainBrightness_ScreenAlt ("Brightness", Range(-1, 1)) = 0
		_MainGammma ("Gamma", Range(0, 5)) = 1
		[HideInInspector] s_start_MainHueShift_ScreenAlt ("Hue Shift--{reference_property:_MainHueShiftToggle,persistent_expand:true,default_expand:true}", Float) = 1
		...
		_MainHueShift_ScreenAlt ("Hue Shift", Range(0, 1)) = 0
		...
		[HideInInspector] s_end_MainHueShift_ScreenAlt ("Name Motion", Float) = 0
		...
		_DecalEmissionStrength1_ScreenAlt ("Emission Strength", Range(0, 20)) = 0
		...
		_DecalBlendAlpha1_ScreenAlt ("Alpha", Range(0, 1)) = 1
		...
		_Decal1VideoEmissionStrength_ScreenAlt ("Emission", Range(0, 20)) = 0
		...
		_DecalBlendAlpha2_ScreenAlt ("Alpha", Range(0, 1)) = 1
		...
		[VectorLabel(Xmin, Ymin, Xmax, Ymax)]_AudioLinkDecal2Scale_ScreenAlt ("Scale Mod", Vector) = (0, 0, 0, 0)
		[Space(7)]
		...
		[VectorLabel(Min, Max)]_AudioLinkDecal2Emission_ScreenAlt ("Emission Mod", Vector) = (0, 0, 0, 0)
		[ToggleUI]_AudioLinkDecalCC2_ScreenAlt ("CC Strip", Float) = 0
		[Space(7)]
		...
		_FlipbookReplace_ScreenAlt ("Replace", Range(0, 1)) = 1
		_FlipbookEmissionStrength ("Emission Strength", Range(0, 20)) = 0
		_FlipbookFPS_ScreenAlt ("FPS", Float) = 30.0
 ...
 #define OPTIMIZER_ENABLED 
			...
			UNITY_DECLARE_TEX2D(_MainTex_ScreenAlt);
			...
			float4 _MainTex_ScreenAlt_ST;
			float2 _MainTexPan;
			float _MainTexUV;
			float4 _MainTex_ScreenAlt_TexelSize;
			...
			float _MainHueShift_ScreenAlt;
			float _MainHueShiftSpeed;
			float _Saturation_ScreenAlt;
			float _MainBrightness_ScreenAlt;
			float _MainGammma;
			...
			float4 _AudioLinkDecal2Scale_ScreenAlt;
			...
			float _Decal1VideoEmissionStrength_ScreenAlt;
			...
			float _DecalEmissionStrength1_ScreenAlt;
			float _DecalBlendAlpha1_ScreenAlt;
			...
			float _DecalBlendAlpha2_ScreenAlt;
			...
			float _FlipbookReplace_ScreenAlt;
			...
			{
				float3 normal = UnpackScaleNormal(POI2D_SAMPLER_PAN(normalTexture, _MainTex_ScreenAlt, poiUV(poiMesh.uv[normalUV], normal_ST), normalPan), normalIntensity);
				return normalize(
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				#if defined(PROP_DECALMASK) || !defined(OPTIMIZER_ENABLED)
				float4 decalMask = POI2D_SAMPLER_PAN(_DecalMask, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_DecalMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				#else
				float4 decalMask = 1;
				#endif
				...
				Decal0.m_DecalScale = float4(0.5,0.5,1,0);
				...
				Decal0.m_DecalBlendAlpha = (0.75 /*_DecalBlendAlpha*/);
				...
				Decal0.m_DecalChannelSeparation = (0.82 /*_Decal0ChannelSeparation*/);
				...
				Decal0.m_DecalChannelSeparationVertical = (-0.56 /*_Decal0ChannelSeparationVertical*/);
				Decal0.m_DecalChannelSeparationAngleStrength = (-2.52 /*_Decal0ChannelSeparationAngleStrength*/);
				...
				Decal0.m_AudioLinkDecalEmissionBand = (4.0 /*_AudioLinkDecal0EmissionBand*/);
				...
				Decal1.m_DecalEmissionStrength = _DecalEmissionStrength1_ScreenAlt;
				Decal1.m_DecalBlendAlpha = _DecalBlendAlpha1_ScreenAlt;
				...
				{
					udonVideoAspectRatio = Decal1.GetVideoAspectRatio(_Udon_VideoTex_TexelSize.zw, (1.0 /*_Decal1VideoAspectFix*/), (1.0 /*_Decal1VideoFitToScale*/));
					if ((1.0 /*_Decal1OnlyVideo*/))
					{
						if (udonVideoTexAvailable)
						{
							Decal1.m_DecalEmissionStrength += _Decal1VideoEmissionStrength_ScreenAlt;
							if ((1.0 /*_Decal1UseDecalAlpha*/))
							{
								Decal1.SampleDecal(_DecalTexture1, poiMods, poiLight, poiMesh, poiCam);
				...
				Decal2.m_DecalScale = float4(0.5,0.5,1,0);
				...
				Decal2.m_DecalBlendAlpha = _DecalBlendAlpha2_ScreenAlt;
				...
				Decal2.m_AudioLinkDecalScale = _AudioLinkDecal2Scale_ScreenAlt;
				...
				Decal2.m_AudioLinkDecalEmission = _AudioLinkDecal2Emission_ScreenAlt;
				...
				Decal2.m_AudioLinkDecalColorChord = _AudioLinkDecalCC2_ScreenAlt;
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float flipBookMask = POI2D_SAMPLER_PAN(_FlipbookMask, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_FlipbookMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_FlipbookMaskChannel*/)];
				#else
				...
				float4 flipbookScaleOffset = float4(1.1,1,0,0);
				#ifdef POI_AUDIOLINK
				if (poiMods.audioLinkAvailable)
				{
				...
				{
					if (_FlipbookFPS_ScreenAlt != 0)
					{
						currentFrame = ((_Time.y / (1 / _FlipbookFPS_ScreenAlt)) + (0.0 /*_FlipbookFrameOffset*/)) % totalFrames;
						if ((0.0 /*_FlipbookStartAndEnd*/))
						{
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, flipBookPixel.rgb, (6.0 /*_FlipbookBlendType*/)), flipBookPixel.a * float4(1,1,1,1).a * _FlipbookReplace_ScreenAlt * flipBookMask * flipbookAlpha);
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(1,0,0,0), (0.0 /*_EmissionAL0StrengthBand*/), float4(1,2,0,0), (0.0 /*_EmissionAL0MultipliersBand*/), (0.0 /*_EmissionAL0Enabled*/));
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex_ScreenAlt, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				...
				if ((0.0 /*_ScrollingEmission*/))
				{
					...
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE) || !defined(OPTIMIZER_ENABLED)
						emissionStrength0 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)) + (dot(pos, float4(0,-10,0,0).xyz) * (20.0 /*_EmissiveScroll_Interval*/)) + _Time.x * (10.0 /*_EmissiveScroll_Velocity*/)).r;
						#endif
					}
					else
					{
				...
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
				float emissionMask0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_EmissionMaskUV*/)], float4(1,1,0,0)) + _Time.x * float4(0,0,0,0))[(0.0 /*_EmissionMaskChannel*/)];
				#else
			...
			void applyVideoEffectsMainTex(inout float4 mainTexture, in PoiMesh poiMesh)
			{
				...
				if ((0.0 /*_VideoPixelateToResolution*/))
				{
					...
					uvs = poiUV(uvs, _MainTex_ScreenAlt_ST) + _Time.x * float4(0,0,0,0);
					mainTexture = _MainTex_ScreenAlt.SampleGrad(sampler_MainTex_ScreenAlt, uvs, ddx(originalUVs), ddy(originalUVs));
				}
			}
			...
			{
				#if defined(PROP_VIDEOPIXELTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float3 pixels = tex2D(_VideoPixelTexture, poiUV(poiMesh.uv[(0.0 /*_VideoPixelTextureUV*/)], float4(0.4,0.4,0,0)) * float4(1280,720,0,0));
				#else
				float3 pixels = 1;
				#endif
				float2 uvs = poiMesh.uv[(0.0 /*_MainTexUV*/)];
				...
				#if defined(PROP_VIDEOMASKTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float screenMask = POI2D_SAMPLER_PAN(_VideoMaskTexture, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_VideoMaskTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_VideoMaskTextureChannel*/)];
				#else
				float screenMask = 1;
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(0.0 /*_MainTexUV*/)].xy, _MainTex_ScreenAlt_ST);
				if ((0.0 /*_MainPixelMode*/))
				{
					mainUV = sharpSample(_MainTex_ScreenAlt_TexelSize, mainUV);
				}
				float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex_ScreenAlt, _MainTex_ScreenAlt, mainUV, float4(0,0,0,0), (0.0 /*_MainTexStochastic*/));
				...
				#endif
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (1.0 /*_BumpScale*/));
				#else
				...
				#if defined(PROP_LIGHTINGAOMAPS) || !defined(OPTIMIZER_ENABLED)
				float4 AOMaps = POI2D_SAMPLER_PAN(_LightingAOMaps, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_LightingAOMapsUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				...
				#if defined(PROP_LIGHTINGDETAILSHADOWMAPS) || !defined(OPTIMIZER_ENABLED)
				float4 DetailShadows = POI2D_SAMPLER_PAN(_LightingDetailShadowMaps, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_LightingDetailShadowMapsUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				#ifndef POI_PASS_ADD
				...
				#if defined(PROP_LIGHTINGSHADOWMASKS) || !defined(OPTIMIZER_ENABLED)
				float4 ShadowMasks = POI2D_SAMPLER_PAN(_LightingShadowMasks, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_LightingShadowMasksUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.9081735,0.4520295,1,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.9081735,0.4520295,1,1).a;
				#ifdef COLOR_GRADING_HDR
				#if defined(PROP_MAINCOLORADJUSTTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 hueShiftAlpha = POI2D_SAMPLER_PAN(_MainColorAdjustTexture, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_MainColorAdjustTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				#else
				...
				{
					float shift = _MainHueShift_ScreenAlt;
					#ifdef POI_AUDIOLINK
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), - (_Saturation_ScreenAlt) * hueShiftAlpha.b);
				poiFragData.baseColor = saturate(lerp(poiFragData.baseColor, poiFragData.baseColor * (_MainBrightness_ScreenAlt + 1), hueShiftAlpha.g));
				#endif
				if ((2.0 /*_MainAlphaMaskMode*/))
				{
					#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
					float alphaMask = POI2D_SAMPLER_PAN(_AlphaMask, _MainTex_ScreenAlt, poiUV(poiMesh.uv[(0.0 /*_AlphaMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0).xy).r;
					#else
					float alphaMask = 1;
					#endif
