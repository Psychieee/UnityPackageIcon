Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/22d4137afebaf5d489ac14b9cffc17dc"
{
	Properties
	{
		...
		[HideInInspector] s_start_MainHueShift_AmpHawk ("Hue Shift--{reference_property:_MainHueShiftToggle,persistent_expand:true,default_expand:true}", Float) = 1
		...
		_MainHueShift_AmpHawk ("Hue Shift", Range(0, 1)) = 0
		...
		[HideInInspector] s_end_MainHueShift_AmpHawk ("Name Motion", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float shift = _MainHueShift_AmpHawk;
					#ifdef POI_AUDIOLINK
