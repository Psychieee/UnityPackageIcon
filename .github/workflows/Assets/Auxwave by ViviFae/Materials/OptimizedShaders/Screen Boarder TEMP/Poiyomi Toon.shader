Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/32ff7f42e285ea240a317bfcc946657b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.07036009,0.07421356,0.07227185,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.07036009,0.07421356,0.07227185,1).a;
				#else
				...
				if (1.0 == 1)
				{
					float shift = 0.0;
					#ifdef POI_AUDIOLINK
					if (poiMods.audioLinkAvailable && 1.0)
					{
