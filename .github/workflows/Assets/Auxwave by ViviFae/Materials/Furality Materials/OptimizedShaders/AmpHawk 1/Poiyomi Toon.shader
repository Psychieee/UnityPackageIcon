Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/1a9dea0cb5949c74fb13fa5726f7fffc"
{
	Properties
	{
		...
		[HideInInspector] s_start_MainHueShift_AmpHawk1 ("Hue Shift--{reference_property:_MainHueShiftToggle,persistent_expand:true,default_expand:true}", Float) = 1
		...
		_MainHueShift_AmpHawk1 ("Hue Shift", Range(0, 1)) = 0
		...
		[HideInInspector] s_end_MainHueShift_AmpHawk1 ("Name Motion", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float shift = _MainHueShift_AmpHawk1;
					#ifdef POI_AUDIOLINK
