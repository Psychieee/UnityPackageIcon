Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/95680232d3695804c9195eb6d268e918"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(1,2,0,0), 0.0, float4(1,2,0,0), 0.0, _EmissionAL0Enabled);
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, 0.0, 0.0, float4(0,0,0,0), _EmissionAL0Enabled, 1.0);
				...
				{
					emissionColor0 = hueShift(emissionColor0, frac(_EmissionHueShift_Eyes + 0.0 * _Time.x), 0.0, 1.0);
